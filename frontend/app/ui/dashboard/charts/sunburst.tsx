    ...
    const drawChart = () => {
        ...
        function clicked(event: any, p: any) {// eslint-disable-line
            ...
            path.transition(t)
                ...
                .filter(function(this:any, d: d3.HierarchyRectangularNode<any>){ // eslint-disable-line
            ...
            label.filter(function(this: any, d: d3.HierarchyRectangularNode<any>){// eslint-disable-line
